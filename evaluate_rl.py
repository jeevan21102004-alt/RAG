...
from src.adaptive_rag.rl_environment import ACTION_ANSWER, ACTION_SEARCH, RetrievalDecisionEnvironment
...
MODEL_PATH = Path("models") / "retrieval_policy.pt"
...
def main() -> None:
    if not MODEL_PATH.exists():
        ...
        print("Run `python train_rl.py` first.")
        return
    ...
    print("========================================")
    print("AdaptiveRAG RL Policy Evaluation (Test Set)")
    print("============================")
    ...
    if results["accuracy"] > baseline:
        print("RL Policy BEATS the majority baseline.")
    else:
        print("RL Policy does NOT beat the majority baseline.")
    print("========================================")
