...
def calculate_reward(expected_action: str, actual_action: str) -> RewardResult:
    """Calculate a deterministic reward by comparing expected vs actual action.
